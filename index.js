...
AppRegistry.registerComponent('React-Native-App-Sandbox', () => App)
// Note: the word in the string, 'AwesomeProject', has to be what the app is registed as or it will fail!
